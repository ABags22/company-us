...
const TechnologyItem = ({ icon, name, desc }: TechnologyItemProps) => (
  <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
...
const TecnologySection = () => {
  return (
    <section id="tecnology" className="py-16 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
